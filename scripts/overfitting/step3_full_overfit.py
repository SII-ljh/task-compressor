...
Usage:
  ...
  python scripts/overfitting/step3_full_overfit.py --lr 1e-3 --no_bf16
"""
...
def train(model, train_loader, val_loader, device, args, use_bf16=False):
    ...
    if val_loader is not None:
        metrics = evaluate(model, val_loader, device, use_bf16=use_bf16)
...
def main():
    ...
    # Summary
    print("\n" + "=" * 60)
    print("  STEP 3: FULL OVERFIT TEST WITH TRAIN/VAL SPLIT (QA)")
    print("=" * 60)
